...
This script (and its accompanying executable `.exe` file in the releases tab) automates the data transfer from an SAP system output file to the MyInvois batch submission template file.
...
* `Excel Merge Runner v4.3.exe`
    *(this file can be found under the releases tab)* This is the bundled, standalone application (version 4.3). It combines the Python script and all necessary files into a single executable. This allows end-users to run the automation **without needing to install Python** on their machines.
